...
def inject_cold_chain_bug() -> None:
    ...
    def _buggy(agent_id, container, available_slots, round_num=0, **kwargs):
        ...
        # Fix implemented by Master Agent: Preserve temperature constraint
...
def inject_deadlock_bug() -> None:
    ...
    def _buggy(container, available_slots, refrigerated_slots=None, **kwargs):
        ...
        return _original_mock(container, available_slots, refrigerated_slots, **kwargs)
